...
<div class="card">
    ...
    <form method="post" action="<?= site_url('/admin/regimes/store') ?>">
        ...
        <div class="field">
            ...
            <input type="number" id="calories_cible" name="calories_cible" value="<?= esc(old('calories_cible')) ?>" required>
        </div>
        <div class="field">
        ...
        <div class="field">
            ...
            <input type="number" id="pourcentage_legumes_verts" name="pourcentage_legumes_verts" value="<?= esc(old('pourcentage_legumes_verts')) ?>" required>
        </div>
        <div class="field">
            <label for="pourcentage_fruits">% Fruits</label>
            <input type="number" id="pourcentage_fruits" name="pourcentage_fruits" value="<?= esc(old('pourcentage_fruits')) ?>" required>
        </div>
        <div class="field">
            <label for="pourcentage_feculents">% Feculents</label>
            <input type="number" id="pourcentage_feculents" name="pourcentage_feculents" value="<?= esc(old('pourcentage_feculents')) ?>" required>
        </div>
        <div class="field">
